...
static const yytype_uint8 yyprhs[] =
{
      ...
      27,    35,    38,    41,    43,    45,    49,    51
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      20,     0,    -1,    21,    -1,    20,    21,    -1,     1,    -1,
      25,    10,    -1,    22,    -1,    24,    -1,     7,    23,     9,
      20,     8,    -1,     3,    18,     5,    -1,    11,     3,    14,
      26,    12,    20,    13,    -1,     6,     3,    -1,     6,     4,
      -1,    16,    -1,    17,    -1,    25,    15,    25,    -1,     3,
      -1,    26,     3,    -1
};
...
{
       0,    25,    25,    28,    31,    34,    37,    40,    45,    49,
      53,    57,    60,    63,    66,    69,    73,    76
};
#endif
...
{
  "$end", "error", "$undefined", "VARIABLE", "STRING", "NUMBER", "EC",
  "IF", "FI", "THEN", "SEMICOLON", "FOR", "DO", "DONE", "IN", "PIPE", "LS",
  "WC", "EQ", "$accept", "statement_list", "statement", "if_statement",
  "condition", "for_loop", "command", "variable_list", 0
};
#endif
...
{
       0,     4,     0,     0,     0,    13,    14,     0,     2,     6,
       7,     0,    11,    12,     0,     0,     0,     1,     3,     5,
       0,     0,     0,     0,    15,     9,     0,    16,     0,     8,
      17,     0,     0,    10
};
...
{
       4,    -8,    38,    -1,     3,    -8,    -8,     1,    -8,    -8,
      -8,    -6,    -8,    -8,    -2,    17,    24,    -8,    -8,    -8,
      -3,    26,     4,    40,    30,    -8,    16,    -8,    25,    -8,
      -8,     4,    23,    -8
};
...
{
      18,    17,    14,     2,    19,     1,    16,     2,     3,    20,
       2,     3,     4,     5,     6,     4,    21,     5,     6,    18,
       5,     6,     2,     3,    29,    18,    22,     4,    30,     2,
       3,    25,     5,     6,     4,    26,    33,    31,    23,     5,
       6,    12,    13,    27,    32,    20,     0,    24
};

static const yytype_int8 yycheck[] =
{
       7,     0,     3,     6,    10,     1,     3,     6,     7,    15,
       6,     7,    11,    16,    17,    11,    18,    16,    17,    26,
      16,    17,     6,     7,     8,    32,     9,    11,     3,     6,
       7,     5,    16,    17,    11,    22,    13,    12,    14,    16,
      17,     3,     4,     3,    31,    15,    -1,    20
};
...
{
       0,     1,     6,     7,    11,    16,    17,    20,    21,    22,
      24,    25,     3,     4,     3,    23,     3,     0,    21,    10,
      15,    18,     9,    14,    25,     5,    20,     3,    26,     8,
       3,    12,    20,    13
};
